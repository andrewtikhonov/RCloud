 ...
 */
public class SearchResultView extends DynamicView {

    SearchResultBrowser browser;

    public SearchResultView(String title, Icon icon, SearchResultBrowser browser, int id) {
    ...
    public SearchResultBrowser getBrowser() {
        return browser;
    }

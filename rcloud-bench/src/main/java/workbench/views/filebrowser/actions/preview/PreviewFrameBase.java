...
public class PreviewFrameBase extends JFrame {
    public PreviewFrameBase() {
        setupPreviewBase();
    }

    public void setupPreviewBase() {
        ...
        ((JPanel)getContentPane()).registerKeyboardAction(disposeListener,
                KeyUtil.getKeyStroke(KeyEvent.VK_ESCAPE, 0),
                JComponent.WHEN_IN_FOCUSED_WINDOW);

        WindowDragMouseAdapter adapter = new WindowDragMouseAdapter();

...
/**
 * Created by andrew on 01/06/15.
 */
public class DBLayerPostgresql extends DBLayer {
    final private Logger log = LoggerFactory.getLogger(getClass());
	public DBLayerPostgresql(ConnectionProvider provider) {
		super(provider);
	}
    ...
    protected String sysdateSelectRequest() {
   		return sysdateFunctionName() + " as \"TIMESTAMP\"";
   	}
